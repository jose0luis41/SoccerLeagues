...
class CrearEquipo extends Component {
  ...
  constructor(props){
    ...
    this.state = {nameT:'',
     ...
     this.crearEquipoVista = this.crearEquipoVista.bind(this);             
    ...
    crearEquipoVista(){
      ...
      axios.post('http://localhost:8080/_ah/api/echo/v1/createTeam/success?cantidadDeTitulos='+cupsParameter+'&fundationYear='+fundationParameter+'&name='+nameParameter,
      ...
      .then(res => {
        ...
        alert('Debes llenar todos los campos para poder crear el equipo');
    }
  }
  ...
  <div>
          ...
          <br/>
          <button onClick={this.crearEquipoVista.bind()}> create </button>
